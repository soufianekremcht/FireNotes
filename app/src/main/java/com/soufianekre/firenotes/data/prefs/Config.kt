package com.soufianekre.firenotes.data.prefs
...
import com.soufianekre.firenotes.helper.AppConstants.CURSOR_PLACEMENT
import com.soufianekre.firenotes.helper.AppConstants.DISPLAY_SUCCESS
import com.soufianekre.firenotes.helper.AppConstants.ENABLE_LINE_WRAP
import com.soufianekre.firenotes.helper.AppConstants.FONT_SIZE_PERCENTAGE
import com.soufianekre.firenotes.helper.AppConstants.GRAVITY
import com.soufianekre.firenotes.helper.AppConstants.GRAVITY_CENTER
import com.soufianekre.firenotes.helper.AppConstants.GRAVITY_LEFT
import com.soufianekre.firenotes.helper.AppConstants.GRAVITY_RIGHT
import com.soufianekre.firenotes.helper.AppConstants.LAST_CREATED_NOTE_TYPE
import com.soufianekre.firenotes.helper.AppConstants.LAST_USED_EXTENSION
import com.soufianekre.firenotes.helper.AppConstants.LAST_USED_SAVE_PATH
import com.soufianekre.firenotes.helper.AppConstants.MONOSPACED_FONT
import com.soufianekre.firenotes.helper.AppConstants.MOVE_UNDONE_CHECKLIST_ITEMS
import com.soufianekre.firenotes.helper.AppConstants.SHOW_KEYBOARD
import com.soufianekre.firenotes.helper.AppConstants.SHOW_NOTE_PICKER
import com.soufianekre.firenotes.helper.AppConstants.SHOW_WORD_COUNT
...
class Config(context: Context)  {
    ...
    var lastCreatedNoteType: Int
        get() = prefs.getInt(LAST_CREATED_NOTE_TYPE, AppConstants.NoteType.TYPE_TEXT.value)
